module Pfizer.Datalake.Ingest.Tabular.TypeInference (inferType) where
...
import Pfizer.Datalake.Ingest.Tabular.InferFieldType
import Pfizer.Datalake.Ingest.Tabular.UntypedRecord
import Pfizer.Datalake.Ingest.TypeUniverse
import Pfizer.Datalake.Util.StrictList (StrictList(..))
import qualified Pfizer.Datalake.Util.StrictList as StrictList
