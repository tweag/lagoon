...
class Lagoon::Source < RecursiveOpenStruct
  DB = Sequel::Database.new
  def initialize(attrs, dlagoon)
  ...
  def get_contents
    ...
    res = @dlagoon.lagoonserver.request_with_auth req
    res.body
  end
  ...
  def to_df(&block)
    ...
    resp = @dlagoon.lagoonserver.request_with_auth req
