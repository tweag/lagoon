...
env_args_names = ["LAGOON_HOST", "LAGOON_PORT",
                  "USER", "PASSWORD"]

yaml_fields = ["lagoonserver_host", "lagoonserver_port",
               "user", "password"]

class LagoonConfig(collections.namedtuple("LagoonConfig", env_args_names)):
